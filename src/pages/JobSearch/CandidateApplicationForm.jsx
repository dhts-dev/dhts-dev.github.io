...
const CandidateApplicationForm = () => {
  ...
  const handleInputChange = (field, type, maxLength = 100) => (e) => {
        ...
        <form onSubmit={handleSubmit} className="w-full max-w-5xl bg-white rounded-lg shadow p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            ...
            <div className="flex flex-col">
              ...
              <select className={inputClass} onChange={handleInputChange('maritalStatus', 'default')}>
            ...
            <div key={index} className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div className="flex flex-col">
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateArray(setExperiences, index, 'companyName', e.target.value, 'generalText', 100)
                  }
                  onKeyPress={handleKeyPress('generalText')}
                  onPaste={handlePaste('generalText')}
              ...
              <div className="flex flex-col">
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateArray(setExperiences, index, 'designation', e.target.value, 'generalText', 50)
                  }
                  onKeyPress={handleKeyPress('generalText')}
                  onPaste={handlePaste('generalText')}
              ...
              <div className="flex flex-col">
                ...
                <input
                  ...
                  className={inputClass}
                  value={exp.from}
                  onChange={(e) => updateArray(setExperiences, index, 'from', e.target.value, 'default')}
                />
              </div>
              <div className="flex flex-col">
                <label>To</label>
                <input
                  ...
                  className={inputClass}
                  value={exp.to}
                  onChange={(e) => updateArray(setExperiences, index, 'to', e.target.value, 'default')}
                />
              </div>
              <div className="flex flex-col">
                ...
                <input
                  className={inputClass}
                  value={exp.salary}
                  onChange={(e) => updateArray(setExperiences, index, 'salary', e.target.value, 'decimal', 15)}
              ...
              <div className="flex flex-col">
                ...
                <input
                  className={inputClass}
                  value={exp.reason}
                  onChange={(e) => updateArray(setExperiences, index, 'reason', e.target.value, 'generalText', 200)}
                  onKeyPress={handleKeyPress('generalText')}
                  onPaste={handlePaste('generalText')}
            ...
            <div key={index} className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div className="flex flex-col">
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateArray(setEducations, index, 'qualification', e.target.value, 'generalText', 100)
                  }
                  onKeyPress={handleKeyPress('generalText')}
                  onPaste={handlePaste('generalText')}
              ...
              <div className="flex flex-col">
                ...
                <input
                  className={inputClass}
                  value={edu.institute}
                  onChange={(e) => updateArray(setEducations, index, 'institute', e.target.value, 'generalText', 150)}
                  onKeyPress={handleKeyPress('generalText')}
                  onPaste={handlePaste('generalText')}
              ...
              <div className="flex flex-col">
                ...
                <input
                  className={inputClass}
                  value={edu.year}
                  onChange={(e) => updateArray(setEducations, index, 'year', e.target.value, 'year', 4)}
              ...
              <div className="flex flex-col">
                ...
                <input
                  className={inputClass}
                  value={edu.marks}
                  onChange={(e) => updateArray(setEducations, index, 'marks', e.target.value, 'marks', 10)}
            ...
            <div key={index} className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div className="flex flex-col">
                ...
                <input
                  ...
                  onChange={(e) => updateArray(setSkills, index, 'skillName', e.target.value, 'generalText', 50)}
                  onKeyPress={handleKeyPress('generalText')}
                  onPaste={handlePaste('generalText')}
              ...
              <div className="flex flex-col">
                ...
                <input
                  ...
                  onChange={(e) => updateArray(setSkills, index, 'institute', e.target.value, 'generalText', 100)}
                  onKeyPress={handleKeyPress('generalText')}
                  onPaste={handlePaste('generalText')}
              ...
              <div className="flex flex-col">
                ...
                <input
                  ...
                  onChange={(e) => updateArray(setSkills, index, 'experience', e.target.value, 'numeric', 2)}
                  onKeyPress={handleKeyPress('numeric')}
                  onPaste={handlePaste('numeric')}
          ...
          <div className="mt-4 mb-6">
            <label className="inline-flex items-start text-base text-gray-700">
              ...
              <span>
                I declare that the information given, herein above, is true and correct to the best
