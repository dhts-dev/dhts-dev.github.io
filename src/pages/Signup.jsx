    ...
    <div className="min-h-screen flex items-center justify-center bg-[#23212b] px-2 py-8">
      <div className="w-full max-w-4xl bg-[#2d2b38] rounded-3xl shadow-2xl flex flex-col md:flex-row overflow-hidden">
        ...
        <div className="md:w-1/2 bg-[#2d2b38] flex flex-col justify-center p-8">
          ...
          <p className="text-gray-400 mb-6">Already have an account? <Link to="/login" className="text-[#f7931e] font-semibold hover:underline">Log in</Link></p>
          <form className="space-y-4">
            <div className="flex gap-4">
              <input type="text" placeholder="First name" className="flex-1 px-4 py-3 rounded-lg bg-[#23212b] text-white focus:outline-none focus:ring-2 focus:ring-[#f7931e]" />
              <input type="text" placeholder="Last name" className="flex-1 px-4 py-3 rounded-lg bg-[#23212b] text-white focus:outline-none focus:ring-2 focus:ring-[#f7931e]" />
            </div>
            ...
            <input type="password" placeholder="Confirm password" className="w-full px-4 py-3 rounded-lg bg-[#23212b] text-white focus:outline-none focus:ring-2 focus:ring-[#f7931e]" />
            <div className="flex items-center">
              <input type="checkbox" id="terms" className="mr-2 accent-[#f7931e]" />
              <label htmlFor="terms" className="text-gray-300 text-sm">I agree to the <a href="#" className="text-[#f7931e] underline">Terms & Conditions</a></label>
            </div>
            <button type="submit" className="w-full py-3 rounded-lg bg-[#f7931e] text-white font-bold text-lg shadow hover:bg-[#d87c0e] transition">Create account</button>
          </form>
