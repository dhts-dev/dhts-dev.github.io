...
const FooterSection = () => {
  ...
  return (
    ...
    >
      {/* QR Code Button */}
      <button className="absolute top-6 right-10 bg-white rounded-xl shadow-lg p-4 flex items-center gap-3 border border-gray-300 hover:shadow-xl transition-all z-50 text-lg">
      ...
      <div className="max-w-7xl mx-auto">
        {/* Main Footer Section */}
        <div className="flex flex-col lg:flex-row flex-wrap justify-between items-start gap-10 mb-12">
          {/* Company Info */}
          ...
          <div className="flex flex-col gap-2 min-w-[180px]">
            ...
            {mainNavigation.map((item, index) => (
              <button
                key={index}
                className="text-base text-left text-global-5 hover:text-global-3 transition-colors"
              >
                {item}
              </button>
            ))}
            <Link
              to="/privacy-policy"
              className="text-base text-global-5 hover:text-global-3 transition-colors"
            >
              Privacy Policy
            </Link>
            <Link
          ...
          {/* Job Seekers + Employers (stacked vertically) */}
